 ...
 */
public enum DeathAttributeMode {
    ...
    DeathAttributeMode(String commandKey, String displayName) {
     ...
     */
    public static DeathAttributeMode fromCommandKey(String key) {
        for (DeathAttributeMode mode : values()) {
    ...
    /** 当前生效的死亡恢复模式 */
    private static DeathAttributeMode currentMode = SNAPSHOT;

    /** 获取当前模式 */
    public static DeathAttributeMode getCurrentMode() {
        return currentMode;
    }

    /** 设置当前模式 */
    public static void setCurrentMode(DeathAttributeMode mode) {
        currentMode = mode;
    }
}
